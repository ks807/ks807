...
I like learning by **building real projects** and experimenting with new technologies.
...
A web project focused on **custom gaming PCs and PC modding**.

**Stack:**

`React` `JavaScript` `CSS` `Node.js` `MySQL` `Clerk`
